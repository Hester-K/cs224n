...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.target_vocab_projection = nn.Linear(in_features=self.hidden_size, out_features=self.hidden_size, bias=False)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        # a_t = torch.squeeze(torch.bmm(torch.transpose(enc_hiddens, 1, 2), torch.unsqueeze(alpha_t, dim=2)), dim=2)
